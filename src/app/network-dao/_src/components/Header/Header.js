...
import config, { NETWORK_TYPE } from "../../../_src/config/config";
import CHAIN_STATE from "../../../_src/config/configCMS.json";
...
class BrowserHeader extends PureComponent {
  ...
  render() {
    ...
    const headerClass = clsx(
      "header-container",
      this.isPhone && "header-container-mobile"
    );

    const networkClass = clsx(
      isMain && `header-main-container${this.isPhone ? "-mobile" : ""}`
    );
